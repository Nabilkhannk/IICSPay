...
const Navbar = () => {
  ...
  <div className="container">
    <a className="navbar-brand" href="#">IICSPay</a>
    ...
    <div className={`collapse navbar-collapse ${show ? "show" : ""}`}>
      ...
      <form className="d-flex">
        <button className="btn btn1-style" type="submit">Sign Up</button>
        <button className="btn btn2-style" type="submit">Login</button>
      </form>
    </div>
  </div>
</nav>
